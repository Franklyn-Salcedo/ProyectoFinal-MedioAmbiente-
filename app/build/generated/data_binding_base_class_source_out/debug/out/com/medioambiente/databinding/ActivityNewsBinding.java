...
public final class ActivityNewsBinding implements ViewBinding {
  ...
  private ActivityNewsBinding(@NonNull LinearLayout rootView, @NonNull TextView errorTextView,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView recyclerViewNews) {
  ...
  public static ActivityNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsBinding((LinearLayout) rootView, errorTextView, progressBar,
          recyclerViewNews);
    }
